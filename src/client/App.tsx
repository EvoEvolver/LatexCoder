          ...
          <div id="topbar-actions" className="flex h-full shrink-0 items-center">
            ...
            <DropdownMenu modal={false}>
              ...
              <DropdownMenuContent align="start">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem id="toggle-blame"><Icon name="scan-text" />Blame<span id="blame-menu-state" className="ml-auto text-[10px] text-muted-foreground">Off</span></DropdownMenuItem>
                <DropdownMenuSeparator />
