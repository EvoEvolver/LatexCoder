...
export function AppShell() {
  return (
    <>
      ...
      <dialog id="agent-access-dialog" className={dialogClass}><div className="p-5"><DialogHeader title="Agent editing" closeId="agent-access-close" /><p className="mb-4 text-xs text-muted-foreground">Copy this command when the agent should edit the live source directly.</p><CopyRow inputId="agent-command" buttonId="copy-agent-link" label="Copy" /><footer className="mt-5 flex justify-end"><Button id="agent-access-done">Done</Button></footer></div></dialog>

      <dialog id="proposal-access-dialog" className={dialogClass}><div className="p-5"><DialogHeader title="Agent proposed changes" closeId="proposal-access-close" /><p className="mb-4 text-xs text-muted-foreground">Use this command to force every agent edit into Review for acceptance or rejection.</p><CopyRow inputId="proposal-agent-command" buttonId="copy-proposal-agent-link" label="Copy" /><footer className="mt-5 flex justify-end"><Button id="proposal-access-done">Done</Button></footer></div></dialog>
